  ...
  return (
    <footer id="footer" className="flex w-full flex-col gap-2">
      ...
      <section className="mx-auto flex w-full max-w-sm flex-wrap gap-6 px-4 pt-12 md:max-w-11xl md:gap-16 md:px-24 md:pt-32 xl:flex-nowrap">
        <div className="flex max-w-md flex-col justify-start rounded-3xl bg-[#121212] p-5 md:rounded-[2.5rem] md:p-10 mx-auto">
        ...
        <div className="flex max-w-md flex-col gap-6 mx-auto">
        ...
        <div className="hidden max-w-min flex-col justify-start rounded-3xl bg-[#121212] px-10 py-8 md:flex md:rounded-[2.5rem] mx-auto">
          <AppDownloadQRCode />
        </div>
      </section>
