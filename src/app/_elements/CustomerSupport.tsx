...
export default function CustomerSupport() {
  return (
    <section className="mx-4 my-12 flex max-w-screen-2xl flex-col gap-10 rounded-3xl bg-gradient-to-br from-[#FAECFF] to-[#38CEFB] p-5 md:mx-auto md:w-full md:flex-row md:justify-between md:gap-12 md:p-20">
      <div className="flex flex-col gap-6 md:max-w-3xl md:gap-20">
        ...
        <div className="text-lg leading-snug text-black md:w-[90%] md:text-2xl md:font-semibold">
...
const CustomerSupportForm = () => {
  return (
    <form
      className="flex w-full max-w-md flex-col gap-4 rounded-3xl bg-[#121212] p-6 text-zinc-100 md:p-10"
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <label
          className="p-1 text-sm font-normal text-white/80"
      ...
      <button
        type="submit"
        className="rounded-lg border-white bg-gradient-to-br from-[#E293FE] to-[#2DEFAE] px-6 py-2 text-lg font-medium text-black transition-all duration-200 ease-in-out hover:from-[#2DEFAE] hover:to-[#E293FE] hover:text-white"
      >
        Request a call back
      </button>
    </form>
