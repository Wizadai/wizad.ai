...
export default function Features() {
  return (
    <>
      <div className="relative mx-auto flex max-w-sm flex-col items-center justify-center w-[90%] md:max-w-screen-2xl md:py-20">
            ...
            <div className="flex flex-col gap-12 md:flex-row md:justify-between">
              <div className="flex w-full flex-col justify-between gap-4 md:gap-7">
                <span className="text-base text-white/80 md:max-w-md md:pt-5 md:text-lg">
                  ...
                  your industry by keeping the Colors, Fonts, Tone and Imagery
                  in mind.
                </span>
        ...
        <section className="flex w-full max-w-screen-2xl flex-col items-center justify-center py-6 md:py-20">
          <div className="flex w-full flex-col lg:flex-row rounded-t-3xl bg-neutral-920 p-3 md:p-10">
            ...
            <div className="w-full md:w-3/5">
              ...
              <div className="space-y-6 text-base font-light text-white/80 md:pt-5 md:text-lg md:font-normal">
                <p className="md:text-nowrap md:leading-normal">
                  ...
                  <br className="hidden md:block" />
                  you to drive traffic, leads, and conversions for your
                  business.
                </p>
                <p className="font-semibold text-white">
        ...
        <section className="flex w-full max-w-screen-2xl flex-col gap-6 px-4 py-12 md:gap-0 md:px-20 md:py-28">
          <h1 className="max-w-7xl text-3xl/tight font-medium md:text-nowrap md:text-5xl/tight lg:text-6xl/tight">
          ...
          <div className="w-full">
            <span className="text-2xl font-medium text-white/80 md:text-5xl/tight">
              <p className="md:w-[80%]">
                ...
                <span className="text-white">10K+ business owners</span> to
                create designs, grow their social media and improve the brand
                positioning — without any extensive design knowledge.
              </p>
              <br />
