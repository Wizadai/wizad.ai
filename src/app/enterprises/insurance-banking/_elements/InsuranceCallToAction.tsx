...
export default function InsuranceCallToAction() {
  return (
    <section className="mx-4 my-12 flex flex-col gap-10 rounded-3xl bg-gradient-to-br from-[#FAECFF] to-[#38CEFB] p-5 md:mx-auto md:w-[95%] md:max-w-10xl md:flex-row md:justify-between md:p-16">
      <div className="flex flex-col gap-6 md:max-w-[65%] md:gap-14">
        <h2 className="font-hero text-3xl/tight font-bold italic text-black md:text-7xl">
          Unlock billion-scale reach by activating the true power of your agents?
        </h2>
        <div className="text-lg leading-snug text-black md:w-[70%] md:text-xl md:font-medium">
          We help insurance enterprises activate their entire agent network effortlessly. Deliver personalized, compliant designs to every agent through WhatsApp or the app, while brand, compliance, and regional teams manage identity, approvals, and access from one place—giving agents the freedom to stay active, consistent, and fully on-brand every day.
        </div>
      </div>
